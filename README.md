...
only accessible with elevated privileges, such as root. Developing or running as root is unreasonable so Signelle uses
port 1080. It can be configured by changing 'port' in Signelle.java.
